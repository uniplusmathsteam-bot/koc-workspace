...
const RATE_AGAIN = 1.7;
const RATE_GOT_IT = 0.7;
const RATE_NEUTRAL = 1.0;
const RATE_MASTERED = 0.1;
const GOT_IT_MASTER_COUNT = 3;
...
function createCardStates(deck) {
  const states = {};
...
function buildRoundCopyPlan(deck, cardStates, roundNumber) {
  if (roundNumber === 1) {
...
function buildRoundQueue(plan, roundNumber, mode) {
